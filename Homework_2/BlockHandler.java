...
public class BlockHandler {
     ...
     * 
     * @return true if the block is valid and has been added, false otherwise   一般用于添加branch
     */
    ...
    /** create a new {@code block} over the max height {@code block} */     //一般是加在主链上
    public Block createBlock(PublicKey myAddress) {
        ...
        Transaction[] txs = txPool.getTransactions().toArray(new Transaction[0]);//把txpool里面所有有效交易都加入txpool
